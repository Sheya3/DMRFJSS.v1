...
//                        utilLevel, dueDateFactor));
        //LIU FEIGE
        // 0, defaultSequencingRule,
        //                defaultRoutingRule,20, 500, 0,
        //                0.95, 4.0,1,1,"tugboat"
        simulations.add(
                DynamicSimulation.standardMissing(simSeed, null, null, 50, 3000, 500,
                        utilLevel, dueDateFactor,1,1,"tugboat"));
...
//                        utilLevel, dueDateFactor));
        ...
        simulations.add(
                DynamicSimulation.standardMissing(simSeed, null, null, 50, 3000, 500,
                        utilLevel, dueDateFactor,1,1,"tugboat",deviation));
...
//                return SchedulingSet.dynamicMissingSet(simSeed, utilLevel, dueDateFactor, objectives, replications);
                return SchedulingSet.dynamicMissingSet(simSeed, utilLevel, dueDateFactor, objectives, replications,deviation);
...
//                return SchedulingSet.dynamicFullSet(simSeed, utilLevel, dueDateFactor, objectives, replications,deviation);
