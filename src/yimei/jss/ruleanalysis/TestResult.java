...
public class TestResult {
	//FEIGE LIU
	private double[] maxFitnessIn50Instance = new double[50];

	private int[][] numberBagindInGen = new int[50][100];
	private Fitness bestFitnessOfRuns;
	private String[] bestRulesOfRuns;
	...
	public double[] getMaxFitnessIn50Instance() {
		return maxFitnessIn50Instance;
	}

	public int[][] getNumberBagindInGen() {
		return numberBagindInGen;
	}

	public Fitness getBestFitnessOfRuns() {
		return bestFitnessOfRuns;
	}

	public void setBestFitnessOfRuns(Fitness bestFitnessOfRuns) {
		this.bestFitnessOfRuns = bestFitnessOfRuns;
	}

	public String[] getBestRulesOfRuns() {
		return bestRulesOfRuns;
	}

	public void setBestRulesOfRuns(String[] bestRulesOfRuns) {
		this.bestRulesOfRuns = bestRulesOfRuns;
	}
