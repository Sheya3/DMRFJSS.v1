...
public class JobArrivalEvent extends AbstractEvent {
    ...
    @Override
    // jobarrivalevent-->operationvisitevent
...
//        }
        ...
        //before there is a bug that all the readytime of operation is 0 and never update---the OWT = system.clocktime
...
//                simulation.getRoutingRule().nextOperationOption(decisionSituation);
        ...
        //LIUFEIGE decide which machine/workcenter
        //1
//         OperationOption operationOption =
//                simulation.getRoutingRule().nextOperationOptionDmachine(decisionSituation);
//         2
//        OperationOption operationOptionion =
//                simulation.getRoutingRule().nextOperationOptionDmachineset(decisionSituation);
//        //3
        OperationOption operationOption =
                        simulation.getRoutingRule().nextOperationOptionDmachineOnce(decisionSituation);

//        //4
//        OperationOption operationOption =
//                simulation.getRoutingRule().nextOperationOptionDmachineTree(decisionSituation);
        operation.getOperationOption().setWorkCenterSet(operationOption.getWorkCenterSet());
        ...
        simulation.addEvent(new OperationVisitEvent(job.getReleaseTime(),  operation.getOperationOption()));
