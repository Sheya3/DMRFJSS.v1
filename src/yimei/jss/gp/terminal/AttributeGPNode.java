...
//        if(calcPrioProb.getOperation() == null ||calcPrioProb.getSystemState() == null) {
////            if( calcPrioProb.getWorkCenter()== null && calcPrioProb.getWorkCenterSet()==null)
...
//        }
        ...
        if(calcPrioProb.getWorkCenterSet()==null){
            data.value = attribute.value(
                    ...
                    calcPrioProb.getWorkCenter(), //modified by FEIGE
                    calcPrioProb.getWorkCenterSet(),
