...
public class GPRun extends Evolve {
    public static String out_dir = "/"; //2021.7.29 define a parameter as the output directory.
    // The original args are divided into two parts.
    public static String jobFilePrefix;

    public static void main(String[] args) {
        System.out.println("GPRun received args: " + java.util.Arrays.toString(args));
        out_dir = args[0];
        jobFilePrefix = out_dir + "/";

        EvolutionState state;
        ParameterDatabase parameters;
        String[] arg_file = Arrays.copyOfRange(args, 1, args.length);
        parameters = loadParameterDatabase(arg_file);
