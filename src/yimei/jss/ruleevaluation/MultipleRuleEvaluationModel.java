...
public class MultipleRuleEvaluationModel extends AbstractEvaluationModel{
    ...
    //LIUFEIGE
    public final static String P_SIM_OBJECTIVE = "objectives";
    public final static String P_SIM_DEVIATION = "deviation";
    public final static String P_SIM_TYPEOFQUESTION = "tugboat";
...
//            int numMachines = state.parameters.getIntWithDefault(p, null, 10);
            ...
            p = b.push(P_SIM_DEVIATION);
            double deviation = state.parameters.getDoubleWithDefault(p, null, 60);
            // Due date factor
            ...
            //LIUFEIGE
            p = b.push(P_SIM_OBJECTIVE);
            String obj = state.parameters.getStringWithDefault(p,null,"?");
            p = b.push(P_SIM_TYPEOFQUESTION);
            String typeOfQuestion = state.parameters.getStringWithDefault(p,null,"tugboat");
...
//                        utilLevel, dueDateFactor, false);
                // LIUFEIGE Dynamic Simulation: tugboat
                System.out.println("UL: "+ utilLevel+" DA: "+ deviation);
                simulation = new DynamicSimulation(simSeed,
                        null, null, numMachines, numJobs, warmupJobs,
                        minNumOperations, maxNumOperations,
